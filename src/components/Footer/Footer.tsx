      ...
      <div className="relative z-20 grid grid-cols-1 items-start gap-20 md:grid-cols-2 md:gap-12">
        <div>
          ...
          <p className="text-tertiary-content">
            O primeiro serviço de análise completa para seu site, projetado para funcionar com
            empresas de diversos níveis e segmentos de negócios.
          </p>
          <a
            href="#"
            className="text-neutral mt-4 inline-flex items-center gap-2 text-xs hover:underline">
            Mais sobre mim <span className="bg-neutral inline-block size-[10px] rounded-full" />
          </a>
        </div>
        ...
        <div className="flex flex-col justify-between gap-[200px] md:flex-row md:gap-8">
          <div className="space-y-10 md:self-end">
            <div className="flex flex-col">
              <h5 className="text-neutral mb-4 text-lg font-medium">Contate-me</h5>
              <a
                href="mailto:b.br3nn0@gmail.com"
                className="text-tertiary-content hover:text-neutral text-sm font-light transition-colors duration-300">
                b.br3nn0@gmail.com
              </a>
              <a
                href="tel:+55 98 98531-7242"
                className="text-tertiary-content hover:text-neutral text-sm font-light transition-colors duration-300">
                +55 98 98531-7242
              </a>
            </div>
            <div>
              <div>
                <h5 className="text-neutral mb-4 text-lg font-medium">Localização</h5>
          ...
          <div className="md:self-end">
            <p className="text-neutral mb-8 text-sm md:text-right">Idiomas</p>
