...
const ProjectCard: React.FC<ProjectCardProps> = ({ data, isFeatured = false }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row min-h-[800px] lg:min-h-[550px] h-auto">
        <div className="relative lg:w-5/12 w-full h-[300px] lg:h-auto">
          <Image
            src={cover}
            alt={title}
            fill
        ...
        <div className="lg:w-7/12 p-6 sm:p-8 lg:p-10 flex flex-col w-full">
